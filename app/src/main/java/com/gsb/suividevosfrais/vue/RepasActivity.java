...
public class RepasActivity extends  Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Global.changeAfficheDate((DatePicker) findViewById(R.id.datRps)) ;
    ...
    private void valoriseProprietes() {
        ...
        annee = ((DatePicker)findViewById(R.id.datRps)).getYear() ;
        mois = ((DatePicker)findViewById(R.id.datRps)).getMonth() + 1 ;
        ...
        fraisF=acsLocalFrais.getFraisDateFrais("repas",dateMois);
    ...
    private void imgReturn_clic() {
        ((ImageView)findViewById(R.id.imgRpReturn)).setOnClickListener(new ImageView.OnClickListener() {
        ...
        ((Button)findViewById(R.id.cmdRepasValider)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                if(idFrais!=null){
                    ...
                    FraisF addFraisF= new FraisF(dateMois,"repas",qte);
    ...
    private void cmdPlus_clic() {
        ((Button)findViewById(R.id.cmdRpPlus)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                qte+=5 ;
                ((EditText)findViewById(R.id.txtRepas)).setText(qte.toString()) ;
            }
    ...
    private void cmdMoins_clic() {
        ((Button)findViewById(R.id.cmdRpMoins)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
    ...
    private void dat_clic() {
        final DatePicker uneDate = (DatePicker)findViewById(R.id.datRps) ;
