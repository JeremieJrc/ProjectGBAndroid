...
public class NuiteeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((EditText)findViewById(R.id.txtNuitee)).setInputType(InputType.TYPE_NULL);
    }
    ...
    private void cmdPlus_clic() {
        ((Button)findViewById(R.id.cmdNtPlus)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                qte+=1 ;
                ((EditText)findViewById(R.id.txtNuitee)).setText(qte.toString()) ;
            }
    ...
    private void cmdMoins_clic() {
        ((Button)findViewById(R.id.cmdNtMoins)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
